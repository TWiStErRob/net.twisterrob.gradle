...
include(":compat:agp-91x")
include(":compat:agp-92x")
include(":compat:agp-93x")
include(":compat:agp-94x")
...
include(":browser:agp-91x")
include(":browser:agp-92x")
include(":browser:agp-93x")
include(":browser:agp-94x")
