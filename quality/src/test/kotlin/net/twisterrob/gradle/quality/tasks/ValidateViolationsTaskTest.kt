...
class ValidateViolationsTaskTest {
	...
	@Test fun `get total violation counts on root project`() {
		...
		gradle.file(gradle.pmd.simple.content, *SOURCE_PATH, "Pmd.java")
		gradle.file(gradle.pmd.simple.config, *CONFIG_PATH_PMD)
	...
	@Test fun `get total violation counts`() {
		...
		gradle.file(gradle.checkstyle.simple.config, *CONFIG_PATH_CS)
		gradle.file(gradle.pmd.simple.content, "module", *SOURCE_PATH, "Pmd.java")
		gradle.file(gradle.pmd.simple.config, *CONFIG_PATH_PMD)
