...
class VersionsTaskTest : BaseIntgTest() {
	...
	@Test fun `print checkstyle version (Gradle 8 latest)`() {
		gradle.gradleVersion = GradleVersion.version("8.14.5")
		...
		result.assertSuccess(":qualityVersions")
		result.assertHasOutputLine("""Gradle version: 8.14.5""")
	...
	@Test fun `print checkstyle version (Gradle 9 latest)`() {
		gradle.gradleVersion = GradleVersion.version("9.4.1")
		...
		result.assertSuccess(":qualityVersions")
		result.assertHasOutputLine("""Gradle version: 9.4.1""")
