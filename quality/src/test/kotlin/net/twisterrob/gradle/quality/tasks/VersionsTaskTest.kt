...
class VersionsTaskTest : BaseIntgTest() {
	...
	@Test fun `print checkstyle version (Gradle 7 latest)`() {
		gradle.gradleVersion = GradleVersion.version("7.6.3")
		...
		result.assertSuccess(":qualityVersions")
		result.assertHasOutputLine("""Gradle version: 7.6.3""")
	...
	@Test fun `print checkstyle version (Gradle 8 latest)`() {
		gradle.gradleVersion = GradleVersion.version("8.6")
		...
		result.assertSuccess(":qualityVersions")
		result.assertHasOutputLine("""Gradle version: 8.6""")
