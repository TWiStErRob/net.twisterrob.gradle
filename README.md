...
Android Gradle Plugin 3.1.4 — 8.13.0 on Gradle 4.9 — 8.14.3 as listed in
...
Currently supported version are Android Gradle Plugin 8.2.1 — 8.13.0 on Gradle 8.2 — 8.14.3 where compatible.
