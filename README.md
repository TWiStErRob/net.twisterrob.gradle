...
Android Gradle Plugin 3.1.4 — 8.10.1 on Gradle 4.9 — 8.14.2 as listed in
...
Currently supported version are Android Gradle Plugin 8.2.1 — 8.10.1 on Gradle 8.2 — 8.14.2 where compatible.
