...
Android Gradle Plugin 3.1.4 — 9.3.2 on Gradle 4.9 — 9.6.1 as listed in
...
Currently supported version are Android Gradle Plugin 8.2.1 — 9.3.2 on Gradle 8.2 — 9.6.1 where compatible.
