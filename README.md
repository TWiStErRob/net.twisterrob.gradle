...
Android Gradle Plugin 3.1.4 — 8.3.1 on Gradle 4.9 — 8.6 as listed in
...
Currently supported version are Android Gradle Plugin 7.0.2 — 8.3.1 on Gradle 7.0 — 8.6 where compatible.
