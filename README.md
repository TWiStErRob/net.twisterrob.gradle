...
Android Gradle Plugin 3.1.4 — 8.1.x on Gradle 4.9 — 8.3.x
...
Currently supported version are Android Gradle Plugin 7.0.x — 8.1.x on Gradle 7.0 — 8.3-rc-3 where compatible.
