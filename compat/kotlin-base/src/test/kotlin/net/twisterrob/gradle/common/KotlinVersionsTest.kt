...
class KotlinVersionsTest {
	...
	companion object {
		...
		fun mavenCentral(): List<Arguments> =
			listOf(
				Arguments.of("2.4.20", KotlinVersion(major = 2, minor = 4, patch = 20)),
				Arguments.of("2.4.20-RC3", KotlinVersion(major = 2, minor = 4, patch = 20)),
				Arguments.of("2.4.20-RC2", KotlinVersion(major = 2, minor = 4, patch = 20)),
				Arguments.of("2.4.20-RC", KotlinVersion(major = 2, minor = 4, patch = 20)),
				Arguments.of("2.4.20-Beta2", KotlinVersion(major = 2, minor = 4, patch = 20)),
				Arguments.of("2.4.20-Beta1", KotlinVersion(major = 2, minor = 4, patch = 20)),
				Arguments.of("2.4.10", KotlinVersion(major = 2, minor = 4, patch = 10)),
				Arguments.of("2.4.10-RC2", KotlinVersion(major = 2, minor = 4, patch = 10)),
				Arguments.of("2.4.10-RC", KotlinVersion(major = 2, minor = 4, patch = 10)),
				Arguments.of("2.4.0", KotlinVersion(major = 2, minor = 4, patch = 0)),
				Arguments.of("2.4.0-RC2", KotlinVersion(major = 2, minor = 4, patch = 0)),
				Arguments.of("2.4.0-RC", KotlinVersion(major = 2, minor = 4, patch = 0)),
				Arguments.of("2.4.0-Beta2", KotlinVersion(major = 2, minor = 4, patch = 0)),
				Arguments.of("2.4.0-Beta1", KotlinVersion(major = 2, minor = 4, patch = 0)),
				Arguments.of("2.3.21", KotlinVersion(major = 2, minor = 3, patch = 21)),
				Arguments.of("2.3.21-RC2", KotlinVersion(major = 2, minor = 3, patch = 21)),
				Arguments.of("2.3.21-RC", KotlinVersion(major = 2, minor = 3, patch = 21)),
				Arguments.of("2.3.20", KotlinVersion(major = 2, minor = 3, patch = 20)),
				Arguments.of("2.3.20-RC3", KotlinVersion(major = 2, minor = 3, patch = 20)),
				Arguments.of("2.3.20-RC2", KotlinVersion(major = 2, minor = 3, patch = 20)),
				Arguments.of("2.3.20-RC", KotlinVersion(major = 2, minor = 3, patch = 20)),
				Arguments.of("2.3.20-Beta2", KotlinVersion(major = 2, minor = 3, patch = 20)),
				Arguments.of("2.3.20-Beta1", KotlinVersion(major = 2, minor = 3, patch = 20)),
				Arguments.of("2.3.10", KotlinVersion(major = 2, minor = 3, patch = 10)),
				Arguments.of("2.3.10-RC2", KotlinVersion(major = 2, minor = 3, patch = 10)),
				Arguments.of("2.3.10-RC", KotlinVersion(major = 2, minor = 3, patch = 10)),
				Arguments.of("2.3.0", KotlinVersion(major = 2, minor = 3, patch = 0)),
				Arguments.of("2.3.0-RC3", KotlinVersion(major = 2, minor = 3, patch = 0)),
				Arguments.of("2.3.0-RC2", KotlinVersion(major = 2, minor = 3, patch = 0)),
				Arguments.of("2.3.0-RC", KotlinVersion(major = 2, minor = 3, patch = 0)),
				Arguments.of("2.3.0-Beta2", KotlinVersion(major = 2, minor = 3, patch = 0)),
				Arguments.of("2.3.0-Beta1", KotlinVersion(major = 2, minor = 3, patch = 0)),
				Arguments.of("2.2.21", KotlinVersion(major = 2, minor = 2, patch = 21)),
				Arguments.of("2.2.21-RC2", KotlinVersion(major = 2, minor = 2, patch = 21)),
				Arguments.of("2.2.21-RC", KotlinVersion(major = 2, minor = 2, patch = 21)),
				Arguments.of("2.2.20", KotlinVersion(major = 2, minor = 2, patch = 20)),
				Arguments.of("2.2.20-RC2", KotlinVersion(major = 2, minor = 2, patch = 20)),
				Arguments.of("2.2.20-RC", KotlinVersion(major = 2, minor = 2, patch = 20)),
				Arguments.of("2.2.20-Beta2", KotlinVersion(major = 2, minor = 2, patch = 20)),
				Arguments.of("2.2.20-Beta1", KotlinVersion(major = 2, minor = 2, patch = 20)),
				Arguments.of("2.2.10", KotlinVersion(major = 2, minor = 2, patch = 10)),
				Arguments.of("2.2.10-RC2", KotlinVersion(major = 2, minor = 2, patch = 10)),
				Arguments.of("2.2.10-RC", KotlinVersion(major = 2, minor = 2, patch = 10)),
				Arguments.of("2.2.0", KotlinVersion(major = 2, minor = 2, patch = 0)),
				Arguments.of("2.2.0-RC3", KotlinVersion(major = 2, minor = 2, patch = 0)),
				Arguments.of("2.2.0-RC2", KotlinVersion(major = 2, minor = 2, patch = 0)),
				Arguments.of("2.2.0-RC", KotlinVersion(major = 2, minor = 2, patch = 0)),
				Arguments.of("2.2.0-Beta2", KotlinVersion(major = 2, minor = 2, patch = 0)),
				Arguments.of("2.2.0-Beta1", KotlinVersion(major = 2, minor = 2, patch = 0)),
