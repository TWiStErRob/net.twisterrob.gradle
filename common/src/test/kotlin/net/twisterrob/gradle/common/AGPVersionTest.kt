...
class AGPVersionTest {
	...
	companion object {
		...
		fun mavenGoogle(): List<Arguments> =
			listOf(
				Arguments.of("9.5.0-alpha06", AGPVersion(9, 5, Alpha, 6)),
				Arguments.of("9.5.0-alpha05", AGPVersion(9, 5, Alpha, 5)),
				Arguments.of("9.5.0-alpha04", AGPVersion(9, 5, Alpha, 4)),
				Arguments.of("9.5.0-alpha03", AGPVersion(9, 5, Alpha, 3)),
				Arguments.of("9.5.0-alpha02", AGPVersion(9, 5, Alpha, 2)),
				Arguments.of("9.5.0-alpha01", AGPVersion(9, 5, Alpha, 1)),
				Arguments.of("9.4.1", AGPVersion(9, 4, Stable, 1)),
				Arguments.of("9.4.0", AGPVersion(9, 4, Stable, 0)),
				Arguments.of("9.4.0-rc02", AGPVersion(9, 4, Candidate, 2)),
				Arguments.of("9.4.0-rc01", AGPVersion(9, 4, Candidate, 1)),
				Arguments.of("9.4.0-alpha08", AGPVersion(9, 4, Alpha, 8)),
				Arguments.of("9.4.0-alpha07", AGPVersion(9, 4, Alpha, 7)),
				Arguments.of("9.4.0-alpha06", AGPVersion(9, 4, Alpha, 6)),
				Arguments.of("9.4.0-alpha05", AGPVersion(9, 4, Alpha, 5)),
				Arguments.of("9.4.0-alpha04", AGPVersion(9, 4, Alpha, 4)),
				Arguments.of("9.4.0-alpha03", AGPVersion(9, 4, Alpha, 3)),
				Arguments.of("9.4.0-alpha02", AGPVersion(9, 4, Alpha, 2)),
				Arguments.of("9.4.0-alpha01", AGPVersion(9, 4, Alpha, 1)),
				Arguments.of("9.3.3", AGPVersion(9, 3, Stable, 3)),
				Arguments.of("9.3.2", AGPVersion(9, 3, Stable, 2)),
				Arguments.of("9.3.1", AGPVersion(9, 3, Stable, 1)),
				Arguments.of("9.3.0", AGPVersion(9, 3, Stable, 0)),
				Arguments.of("9.3.0-rc02", AGPVersion(9, 3, Candidate, 2)),
				Arguments.of("9.3.0-rc01", AGPVersion(9, 3, Candidate, 1)),
				Arguments.of("9.3.0-alpha12", AGPVersion(9, 3, Alpha, 12)),
				Arguments.of("9.3.0-alpha11", AGPVersion(9, 3, Alpha, 11)),
				Arguments.of("9.3.0-alpha10", AGPVersion(9, 3, Alpha, 10)),
				Arguments.of("9.3.0-alpha09", AGPVersion(9, 3, Alpha, 9)),
				Arguments.of("9.3.0-alpha08", AGPVersion(9, 3, Alpha, 8)),
				Arguments.of("9.3.0-alpha07", AGPVersion(9, 3, Alpha, 7)),
				Arguments.of("9.3.0-alpha06", AGPVersion(9, 3, Alpha, 6)),
				Arguments.of("9.3.0-alpha05", AGPVersion(9, 3, Alpha, 5)),
				Arguments.of("9.3.0-alpha04", AGPVersion(9, 3, Alpha, 4)),
				Arguments.of("9.3.0-alpha03", AGPVersion(9, 3, Alpha, 3)),
				Arguments.of("9.3.0-alpha02", AGPVersion(9, 3, Alpha, 2)),
				Arguments.of("9.3.0-alpha01", AGPVersion(9, 3, Alpha, 1)),
				Arguments.of("9.2.1", AGPVersion(9, 2, Stable, 1)),
				Arguments.of("9.2.0", AGPVersion(9, 2, Stable, 0)),
				Arguments.of("9.2.0-rc01", AGPVersion(9, 2, Candidate, 1)),
				Arguments.of("9.2.0-alpha08", AGPVersion(9, 2, Alpha, 8)),
				Arguments.of("9.2.0-alpha07", AGPVersion(9, 2, Alpha, 7)),
				Arguments.of("9.2.0-alpha06", AGPVersion(9, 2, Alpha, 6)),
				Arguments.of("9.2.0-alpha05", AGPVersion(9, 2, Alpha, 5)),
				Arguments.of("9.2.0-alpha04", AGPVersion(9, 2, Alpha, 4)),
				Arguments.of("9.2.0-alpha03", AGPVersion(9, 2, Alpha, 3)),
				Arguments.of("9.2.0-alpha02", AGPVersion(9, 2, Alpha, 2)),
				Arguments.of("9.2.0-alpha01", AGPVersion(9, 2, Alpha, 1)),
				Arguments.of("9.1.1", AGPVersion(9, 1, Stable, 1)),
				Arguments.of("9.1.0", AGPVersion(9, 1, Stable, 0)),
				Arguments.of("9.1.0-rc01", AGPVersion(9, 1, Candidate, 1)),
				Arguments.of("9.1.0-alpha09", AGPVersion(9, 1, Alpha, 9)),
				Arguments.of("9.1.0-alpha08", AGPVersion(9, 1, Alpha, 8)),
				Arguments.of("9.1.0-alpha07", AGPVersion(9, 1, Alpha, 7)),
				Arguments.of("9.1.0-alpha06", AGPVersion(9, 1, Alpha, 6)),
				Arguments.of("9.1.0-alpha05", AGPVersion(9, 1, Alpha, 5)),
				Arguments.of("9.1.0-alpha04", AGPVersion(9, 1, Alpha, 4)),
				Arguments.of("9.1.0-alpha03", AGPVersion(9, 1, Alpha, 3)),
				Arguments.of("9.1.0-alpha02", AGPVersion(9, 1, Alpha, 2)),
				Arguments.of("9.1.0-alpha01", AGPVersion(9, 1, Alpha, 1)),
				Arguments.of("9.0.1", AGPVersion(9, 0, Stable, 1)),
				Arguments.of("9.0.0", AGPVersion(9, 0, Stable, 0)),
				Arguments.of("9.0.0-rc03", AGPVersion(9, 0, Candidate, 3)),
				Arguments.of("9.0.0-rc02", AGPVersion(9, 0, Candidate, 2)),
				Arguments.of("9.0.0-rc01", AGPVersion(9, 0, Candidate, 1)),
				Arguments.of("9.0.0-beta05", AGPVersion(9, 0, Beta, 5)),
				Arguments.of("9.0.0-beta04", AGPVersion(9, 0, Beta, 4)),
				Arguments.of("9.0.0-beta03", AGPVersion(9, 0, Beta, 3)),
				Arguments.of("9.0.0-beta02", AGPVersion(9, 0, Beta, 2)),
				Arguments.of("9.0.0-beta01", AGPVersion(9, 0, Beta, 1)),
				Arguments.of("9.0.0-alpha14", AGPVersion(9, 0, Alpha, 14)),
				Arguments.of("9.0.0-alpha13", AGPVersion(9, 0, Alpha, 13)),
				Arguments.of("9.0.0-alpha12", AGPVersion(9, 0, Alpha, 12)),
				Arguments.of("9.0.0-alpha11", AGPVersion(9, 0, Alpha, 11)),
				Arguments.of("9.0.0-alpha10", AGPVersion(9, 0, Alpha, 10)),
				Arguments.of("9.0.0-alpha09", AGPVersion(9, 0, Alpha, 9)),
				Arguments.of("9.0.0-alpha08", AGPVersion(9, 0, Alpha, 8)),
				Arguments.of("9.0.0-alpha07", AGPVersion(9, 0, Alpha, 7)),
				Arguments.of("9.0.0-alpha06", AGPVersion(9, 0, Alpha, 6)),
				Arguments.of("9.0.0-alpha05", AGPVersion(9, 0, Alpha, 5)),
				Arguments.of("9.0.0-alpha04", AGPVersion(9, 0, Alpha, 4)),
				Arguments.of("9.0.0-alpha03", AGPVersion(9, 0, Alpha, 3)),
				Arguments.of("9.0.0-alpha02", AGPVersion(9, 0, Alpha, 2)),
				Arguments.of("9.0.0-alpha01", AGPVersion(9, 0, Alpha, 1)),
				Arguments.of("8.13.2", AGPVersion(8, 13, Stable, 2)),
				Arguments.of("8.13.1", AGPVersion(8, 13, Stable, 1)),
				Arguments.of("8.13.0", AGPVersion(8, 13, Stable, 0)),
				Arguments.of("8.13.0-rc02", AGPVersion(8, 13, Candidate, 2)),
				Arguments.of("8.13.0-rc01", AGPVersion(8, 13, Candidate, 1)),
				Arguments.of("8.13.0-alpha04", AGPVersion(8, 13, Alpha, 4)),
				Arguments.of("8.13.0-alpha03", AGPVersion(8, 13, Alpha, 3)),
				Arguments.of("8.13.0-alpha02", AGPVersion(8, 13, Alpha, 2)),
				Arguments.of("8.13.0-alpha01", AGPVersion(8, 13, Alpha, 1)),
				Arguments.of("8.12.3", AGPVersion(8, 12, Stable, 3)),
				Arguments.of("8.12.2", AGPVersion(8, 12, Stable, 2)),
				Arguments.of("8.12.1", AGPVersion(8, 12, Stable, 1)),
				Arguments.of("8.12.0", AGPVersion(8, 12, Stable, 0)),
				Arguments.of("8.12.0-rc01", AGPVersion(8, 12, Candidate, 1)),
				Arguments.of("8.12.0-alpha09", AGPVersion(8, 12, Alpha, 9)),
				Arguments.of("8.12.0-alpha08", AGPVersion(8, 12, Alpha, 8)),
				Arguments.of("8.12.0-alpha07", AGPVersion(8, 12, Alpha, 7)),
				Arguments.of("8.12.0-alpha06", AGPVersion(8, 12, Alpha, 6)),
				Arguments.of("8.12.0-alpha05", AGPVersion(8, 12, Alpha, 5)),
				Arguments.of("8.12.0-alpha04", AGPVersion(8, 12, Alpha, 4)),
				Arguments.of("8.12.0-alpha03", AGPVersion(8, 12, Alpha, 3)),
				Arguments.of("8.12.0-alpha02", AGPVersion(8, 12, Alpha, 2)),
				Arguments.of("8.12.0-alpha01", AGPVersion(8, 12, Alpha, 1)),
				Arguments.of("8.11.2", AGPVersion(8, 11, Stable, 2)),
				Arguments.of("8.11.1", AGPVersion(8, 11, Stable, 1)),
				Arguments.of("8.11.0", AGPVersion(8, 11, Stable, 0)),
				Arguments.of("8.11.0-rc02", AGPVersion(8, 11, Candidate, 2)),
				Arguments.of("8.11.0-rc01", AGPVersion(8, 11, Candidate, 1)),
				Arguments.of("8.11.0-alpha10", AGPVersion(8, 11, Alpha, 10)),
				Arguments.of("8.11.0-alpha09", AGPVersion(8, 11, Alpha, 9)),
				Arguments.of("8.11.0-alpha08", AGPVersion(8, 11, Alpha, 8)),
				Arguments.of("8.11.0-alpha07", AGPVersion(8, 11, Alpha, 7)),
				Arguments.of("8.11.0-alpha06", AGPVersion(8, 11, Alpha, 6)),
				Arguments.of("8.11.0-alpha05", AGPVersion(8, 11, Alpha, 5)),
				Arguments.of("8.11.0-alpha04", AGPVersion(8, 11, Alpha, 4)),
				Arguments.of("8.11.0-alpha03", AGPVersion(8, 11, Alpha, 3)),
				Arguments.of("8.11.0-alpha02", AGPVersion(8, 11, Alpha, 2)),
				Arguments.of("8.11.0-alpha01", AGPVersion(8, 11, Alpha, 1)),
				Arguments.of("8.10.1", AGPVersion(8, 10, Stable, 1)),
				Arguments.of("8.10.0", AGPVersion(8, 10, Stable, 0)),
				Arguments.of("8.10.0-rc04", AGPVersion(8, 10, Candidate, 4)),
				Arguments.of("8.10.0-rc03", AGPVersion(8, 10, Candidate, 3)),
				Arguments.of("8.10.0-rc02", AGPVersion(8, 10, Candidate, 2)),
				Arguments.of("8.10.0-rc01", AGPVersion(8, 10, Candidate, 1)),
				Arguments.of("8.10.0-beta01", AGPVersion(8, 10, Beta, 1)),
				Arguments.of("8.10.0-alpha08", AGPVersion(8, 10, Alpha, 8)),
				Arguments.of("8.10.0-alpha07", AGPVersion(8, 10, Alpha, 7)),
				Arguments.of("8.10.0-alpha06", AGPVersion(8, 10, Alpha, 6)),
				Arguments.of("8.10.0-alpha05", AGPVersion(8, 10, Alpha, 5)),
				Arguments.of("8.10.0-alpha04", AGPVersion(8, 10, Alpha, 4)),
				Arguments.of("8.10.0-alpha03", AGPVersion(8, 10, Alpha, 3)),
				Arguments.of("8.10.0-alpha02", AGPVersion(8, 10, Alpha, 2)),
				Arguments.of("8.10.0-alpha01", AGPVersion(8, 10, Alpha, 1)),
				Arguments.of("8.9.3", AGPVersion(8, 9, Stable, 3)),
				Arguments.of("8.9.2", AGPVersion(8, 9, Stable, 2)),
				Arguments.of("8.9.1", AGPVersion(8, 9, Stable, 1)),
				Arguments.of("8.9.0", AGPVersion(8, 9, Stable, 0)),
				Arguments.of("8.9.0-rc02", AGPVersion(8, 9, Candidate, 2)),
				Arguments.of("8.9.0-rc01", AGPVersion(8, 9, Candidate, 1)),
				Arguments.of("8.9.0-beta01", AGPVersion(8, 9, Beta, 1)),
				Arguments.of("8.9.0-alpha09", AGPVersion(8, 9, Alpha, 9)),
				Arguments.of("8.9.0-alpha08", AGPVersion(8, 9, Alpha, 8)),
				Arguments.of("8.9.0-alpha07", AGPVersion(8, 9, Alpha, 7)),
				Arguments.of("8.9.0-alpha06", AGPVersion(8, 9, Alpha, 6)),
				Arguments.of("8.9.0-alpha05", AGPVersion(8, 9, Alpha, 5)),
				Arguments.of("8.9.0-alpha04", AGPVersion(8, 9, Alpha, 4)),
				Arguments.of("8.9.0-alpha03", AGPVersion(8, 9, Alpha, 3)),
				Arguments.of("8.9.0-alpha02", AGPVersion(8, 9, Alpha, 2)),
				Arguments.of("8.9.0-alpha01", AGPVersion(8, 9, Alpha, 1)),
				Arguments.of("8.8.2", AGPVersion(8, 8, Stable, 2)),
				Arguments.of("8.8.1", AGPVersion(8, 8, Stable, 1)),
				Arguments.of("8.8.0", AGPVersion(8, 8, Stable, 0)),
				Arguments.of("8.8.0-rc02", AGPVersion(8, 8, Candidate, 2)),
				Arguments.of("8.8.0-rc01", AGPVersion(8, 8, Candidate, 1)),
				Arguments.of("8.8.0-beta01", AGPVersion(8, 8, Beta, 1)),
				Arguments.of("8.8.0-alpha09", AGPVersion(8, 8, Alpha, 9)),
				Arguments.of("8.8.0-alpha08", AGPVersion(8, 8, Alpha, 8)),
				Arguments.of("8.8.0-alpha07", AGPVersion(8, 8, Alpha, 7)),
				Arguments.of("8.8.0-alpha06", AGPVersion(8, 8, Alpha, 6)),
				Arguments.of("8.8.0-alpha05", AGPVersion(8, 8, Alpha, 5)),
				Arguments.of("8.8.0-alpha04", AGPVersion(8, 8, Alpha, 4)),
				Arguments.of("8.8.0-alpha03", AGPVersion(8, 8, Alpha, 3)),
				Arguments.of("8.8.0-alpha02", AGPVersion(8, 8, Alpha, 2)),
				Arguments.of("8.8.0-alpha01", AGPVersion(8, 8, Alpha, 1)),
				Arguments.of("8.7.3", AGPVersion(8, 7, Stable, 3)),
				Arguments.of("8.7.2", AGPVersion(8, 7, Stable, 2)),
				Arguments.of("8.7.1", AGPVersion(8, 7, Stable, 1)),
				Arguments.of("8.7.0", AGPVersion(8, 7, Stable, 0)),
				Arguments.of("8.7.0-rc01", AGPVersion(8, 7, Candidate, 1)),
				Arguments.of("8.7.0-beta02", AGPVersion(8, 7, Beta, 2)),
				Arguments.of("8.7.0-beta01", AGPVersion(8, 7, Beta, 1)),
				Arguments.of("8.7.0-alpha09", AGPVersion(8, 7, Alpha, 9)),
				Arguments.of("8.7.0-alpha08", AGPVersion(8, 7, Alpha, 8)),
				Arguments.of("8.7.0-alpha07", AGPVersion(8, 7, Alpha, 7)),
				Arguments.of("8.7.0-alpha06", AGPVersion(8, 7, Alpha, 6)),
				Arguments.of("8.7.0-alpha05", AGPVersion(8, 7, Alpha, 5)),
				Arguments.of("8.7.0-alpha04", AGPVersion(8, 7, Alpha, 4)),
				Arguments.of("8.7.0-alpha03", AGPVersion(8, 7, Alpha, 3)),
				Arguments.of("8.7.0-alpha02", AGPVersion(8, 7, Alpha, 2)),
				Arguments.of("8.7.0-alpha01", AGPVersion(8, 7, Alpha, 1)),
				Arguments.of("8.6.1", AGPVersion(8, 6, Stable, 1)),
				Arguments.of("8.6.0", AGPVersion(8, 6, Stable, 0)),
				Arguments.of("8.6.0-rc01", AGPVersion(8, 6, Candidate, 1)),
				Arguments.of("8.6.0-beta02", AGPVersion(8, 6, Beta, 2)),
				Arguments.of("8.6.0-beta01", AGPVersion(8, 6, Beta, 1)),
				Arguments.of("8.6.0-alpha08", AGPVersion(8, 6, Alpha, 8)),
				Arguments.of("8.6.0-alpha07", AGPVersion(8, 6, Alpha, 7)),
				Arguments.of("8.6.0-alpha06", AGPVersion(8, 6, Alpha, 6)),
				Arguments.of("8.6.0-alpha05", AGPVersion(8, 6, Alpha, 5)),
				Arguments.of("8.6.0-alpha04", AGPVersion(8, 6, Alpha, 4)),
				Arguments.of("8.6.0-alpha03", AGPVersion(8, 6, Alpha, 3)),
				Arguments.of("8.6.0-alpha02", AGPVersion(8, 6, Alpha, 2)),
				Arguments.of("8.6.0-alpha01", AGPVersion(8, 6, Alpha, 1)),
				Arguments.of("8.5.2", AGPVersion(8, 5, Stable, 2)),
				Arguments.of("8.5.1", AGPVersion(8, 5, Stable, 1)),
				Arguments.of("8.5.0", AGPVersion(8, 5, Stable, 0)),
				Arguments.of("8.5.0-rc02", AGPVersion(8, 5, Candidate, 2)),
				Arguments.of("8.5.0-rc01", AGPVersion(8, 5, Candidate, 1)),
				Arguments.of("8.5.0-beta02", AGPVersion(8, 5, Beta, 2)),
				Arguments.of("8.5.0-beta01", AGPVersion(8, 5, Beta, 1)),
				Arguments.of("8.5.0-alpha08", AGPVersion(8, 5, Alpha, 8)),
				Arguments.of("8.5.0-alpha07", AGPVersion(8, 5, Alpha, 7)),
				Arguments.of("8.5.0-alpha06", AGPVersion(8, 5, Alpha, 6)),
				Arguments.of("8.5.0-alpha05", AGPVersion(8, 5, Alpha, 5)),
				Arguments.of("8.5.0-alpha04", AGPVersion(8, 5, Alpha, 4)),
				Arguments.of("8.5.0-alpha03", AGPVersion(8, 5, Alpha, 3)),
				Arguments.of("8.5.0-alpha02", AGPVersion(8, 5, Alpha, 2)),
				Arguments.of("8.5.0-alpha01", AGPVersion(8, 5, Alpha, 1)),
				Arguments.of("8.4.2", AGPVersion(8, 4, Stable, 2)),
				Arguments.of("8.4.1", AGPVersion(8, 4, Stable, 1)),
				Arguments.of("8.4.0", AGPVersion(8, 4, Stable, 0)),
				Arguments.of("8.4.0-rc02", AGPVersion(8, 4, Candidate, 2)),
				Arguments.of("8.4.0-rc01", AGPVersion(8, 4, Candidate, 1)),
				Arguments.of("8.4.0-beta02", AGPVersion(8, 4, Beta, 2)),
				Arguments.of("8.4.0-beta01", AGPVersion(8, 4, Beta, 1)),
				Arguments.of("8.4.0-alpha13", AGPVersion(8, 4, Alpha, 13)),
				Arguments.of("8.4.0-alpha12", AGPVersion(8, 4, Alpha, 12)),
				Arguments.of("8.4.0-alpha11", AGPVersion(8, 4, Alpha, 11)),
				Arguments.of("8.4.0-alpha10", AGPVersion(8, 4, Alpha, 10)),
				Arguments.of("8.4.0-alpha09", AGPVersion(8, 4, Alpha, 9)),
				Arguments.of("8.4.0-alpha08", AGPVersion(8, 4, Alpha, 8)),
				Arguments.of("8.4.0-alpha07", AGPVersion(8, 4, Alpha, 7)),
				Arguments.of("8.4.0-alpha06", AGPVersion(8, 4, Alpha, 6)),
				Arguments.of("8.4.0-alpha05", AGPVersion(8, 4, Alpha, 5)),
				Arguments.of("8.4.0-alpha04", AGPVersion(8, 4, Alpha, 4)),
				Arguments.of("8.4.0-alpha03", AGPVersion(8, 4, Alpha, 3)),
				Arguments.of("8.4.0-alpha02", AGPVersion(8, 4, Alpha, 2)),
				Arguments.of("8.4.0-alpha01", AGPVersion(8, 4, Alpha, 1)),
				Arguments.of("8.3.2", AGPVersion(8, 3, Stable, 2)),
				Arguments.of("8.3.1", AGPVersion(8, 3, Stable, 1)),
				Arguments.of("8.3.0", AGPVersion(8, 3, Stable, 0)),
				Arguments.of("8.3.0-rc02", AGPVersion(8, 3, Candidate, 2)),
				Arguments.of("8.3.0-rc01", AGPVersion(8, 3, Candidate, 1)),
				Arguments.of("8.3.0-beta02", AGPVersion(8, 3, Beta, 2)),
				Arguments.of("8.3.0-beta01", AGPVersion(8, 3, Beta, 1)),
				Arguments.of("8.3.0-alpha18", AGPVersion(8, 3, Alpha, 18)),
				Arguments.of("8.3.0-alpha17", AGPVersion(8, 3, Alpha, 17)),
				Arguments.of("8.3.0-alpha16", AGPVersion(8, 3, Alpha, 16)),
				Arguments.of("8.3.0-alpha15", AGPVersion(8, 3, Alpha, 15)),
				Arguments.of("8.3.0-alpha14", AGPVersion(8, 3, Alpha, 14)),
				Arguments.of("8.3.0-alpha13", AGPVersion(8, 3, Alpha, 13)),
				Arguments.of("8.3.0-alpha12", AGPVersion(8, 3, Alpha, 12)),
				Arguments.of("8.3.0-alpha11", AGPVersion(8, 3, Alpha, 11)),
				Arguments.of("8.3.0-alpha10", AGPVersion(8, 3, Alpha, 10)),
				Arguments.of("8.3.0-alpha09", AGPVersion(8, 3, Alpha, 9)),
				Arguments.of("8.3.0-alpha08", AGPVersion(8, 3, Alpha, 8)),
				Arguments.of("8.3.0-alpha07", AGPVersion(8, 3, Alpha, 7)),
				Arguments.of("8.3.0-alpha06", AGPVersion(8, 3, Alpha, 6)),
				Arguments.of("8.3.0-alpha05", AGPVersion(8, 3, Alpha, 5)),
				Arguments.of("8.3.0-alpha04", AGPVersion(8, 3, Alpha, 4)),
				Arguments.of("8.3.0-alpha03", AGPVersion(8, 3, Alpha, 3)),
				Arguments.of("8.3.0-alpha02", AGPVersion(8, 3, Alpha, 2)),
				Arguments.of("8.3.0-alpha01", AGPVersion(8, 3, Alpha, 1)),
				Arguments.of("8.2.2", AGPVersion(8, 2, Stable, 2)),
				Arguments.of("8.2.1", AGPVersion(8, 2, Stable, 1)),
				Arguments.of("8.2.0", AGPVersion(8, 2, Stable, 0)),
				Arguments.of("8.2.0-rc03", AGPVersion(8, 2, Candidate, 3)),
				Arguments.of("8.2.0-rc02", AGPVersion(8, 2, Candidate, 2)),
				Arguments.of("8.2.0-rc01", AGPVersion(8, 2, Candidate, 1)),
				Arguments.of("8.2.0-beta06", AGPVersion(8, 2, Beta, 6)),
				Arguments.of("8.2.0-beta05", AGPVersion(8, 2, Beta, 5)),
				Arguments.of("8.2.0-beta04", AGPVersion(8, 2, Beta, 4)),
				Arguments.of("8.2.0-beta03", AGPVersion(8, 2, Beta, 3)),
				Arguments.of("8.2.0-beta02", AGPVersion(8, 2, Beta, 2)),
				Arguments.of("8.2.0-beta01", AGPVersion(8, 2, Beta, 1)),
				Arguments.of("8.2.0-alpha16", AGPVersion(8, 2, Alpha, 16)),
				Arguments.of("8.2.0-alpha15", AGPVersion(8, 2, Alpha, 15)),
				Arguments.of("8.2.0-alpha14", AGPVersion(8, 2, Alpha, 14)),
				Arguments.of("8.2.0-alpha13", AGPVersion(8, 2, Alpha, 13)),
				Arguments.of("8.2.0-alpha12", AGPVersion(8, 2, Alpha, 12)),
				Arguments.of("8.2.0-alpha11", AGPVersion(8, 2, Alpha, 11)),
				Arguments.of("8.2.0-alpha10", AGPVersion(8, 2, Alpha, 10)),
				Arguments.of("8.2.0-alpha09", AGPVersion(8, 2, Alpha, 9)),
				Arguments.of("8.2.0-alpha08", AGPVersion(8, 2, Alpha, 8)),
				Arguments.of("8.2.0-alpha07", AGPVersion(8, 2, Alpha, 7)),
				Arguments.of("8.2.0-alpha06", AGPVersion(8, 2, Alpha, 6)),
				Arguments.of("8.2.0-alpha05", AGPVersion(8, 2, Alpha, 5)),
				Arguments.of("8.2.0-alpha04", AGPVersion(8, 2, Alpha, 4)),
				Arguments.of("8.2.0-alpha03", AGPVersion(8, 2, Alpha, 3)),
				Arguments.of("8.2.0-alpha02", AGPVersion(8, 2, Alpha, 2)),
				Arguments.of("8.2.0-alpha01", AGPVersion(8, 2, Alpha, 1)),
				Arguments.of("8.1.4", AGPVersion(8, 1, Stable, 4)),
				Arguments.of("8.1.3", AGPVersion(8, 1, Stable, 3)),
				Arguments.of("8.1.2", AGPVersion(8, 1, Stable, 2)),
				Arguments.of("8.1.1", AGPVersion(8, 1, Stable, 1)),
				Arguments.of("8.1.0", AGPVersion(8, 1, Stable, 0)),
				Arguments.of("8.1.0-rc01", AGPVersion(8, 1, Candidate, 1)),
				Arguments.of("8.1.0-beta05", AGPVersion(8, 1, Beta, 5)),
				Arguments.of("8.1.0-beta04", AGPVersion(8, 1, Beta, 4)),
				Arguments.of("8.1.0-beta03", AGPVersion(8, 1, Beta, 3)),
				Arguments.of("8.1.0-beta02", AGPVersion(8, 1, Beta, 2)),
				Arguments.of("8.1.0-beta01", AGPVersion(8, 1, Beta, 1)),
				Arguments.of("8.1.0-alpha11", AGPVersion(8, 1, Alpha, 11)),
				Arguments.of("8.1.0-alpha10", AGPVersion(8, 1, Alpha, 10)),
				Arguments.of("8.1.0-alpha09", AGPVersion(8, 1, Alpha, 9)),
				Arguments.of("8.1.0-alpha08", AGPVersion(8, 1, Alpha, 8)),
				Arguments.of("8.1.0-alpha07", AGPVersion(8, 1, Alpha, 7)),
				Arguments.of("8.1.0-alpha06", AGPVersion(8, 1, Alpha, 6)),
				Arguments.of("8.1.0-alpha05", AGPVersion(8, 1, Alpha, 5)),
				Arguments.of("8.1.0-alpha04", AGPVersion(8, 1, Alpha, 4)),
				Arguments.of("8.1.0-alpha03", AGPVersion(8, 1, Alpha, 3)),
				Arguments.of("8.1.0-alpha02", AGPVersion(8, 1, Alpha, 2)),
				Arguments.of("8.1.0-alpha01", AGPVersion(8, 1, Alpha, 1)),
				Arguments.of("8.0.2", AGPVersion(8, 0, Stable, 2)),
				Arguments.of("8.0.1", AGPVersion(8, 0, Stable, 1)),
				Arguments.of("8.0.0", AGPVersion(8, 0, Stable, 0)),
				Arguments.of("8.0.0-rc01", AGPVersion(8, 0, Candidate, 1)),
				Arguments.of("8.0.0-beta05", AGPVersion(8, 0, Beta, 5)),
				Arguments.of("8.0.0-beta04", AGPVersion(8, 0, Beta, 4)),
				Arguments.of("8.0.0-beta03", AGPVersion(8, 0, Beta, 3)),
				Arguments.of("8.0.0-beta02", AGPVersion(8, 0, Beta, 2)),
				Arguments.of("8.0.0-beta01", AGPVersion(8, 0, Beta, 1)),
				Arguments.of("8.0.0-alpha11", AGPVersion(8, 0, Alpha, 11)),
				Arguments.of("8.0.0-alpha10", AGPVersion(8, 0, Alpha, 10)),
				Arguments.of("8.0.0-alpha09", AGPVersion(8, 0, Alpha, 9)),
				Arguments.of("8.0.0-alpha08", AGPVersion(8, 0, Alpha, 8)),
				Arguments.of("8.0.0-alpha07", AGPVersion(8, 0, Alpha, 7)),
				Arguments.of("8.0.0-alpha06", AGPVersion(8, 0, Alpha, 6)),
				Arguments.of("8.0.0-alpha05", AGPVersion(8, 0, Alpha, 5)),
				Arguments.of("8.0.0-alpha04", AGPVersion(8, 0, Alpha, 4)),
				Arguments.of("8.0.0-alpha03", AGPVersion(8, 0, Alpha, 3)),
				Arguments.of("8.0.0-alpha02", AGPVersion(8, 0, Alpha, 2)),
				Arguments.of("8.0.0-alpha01", AGPVersion(8, 0, Alpha, 1)),
				Arguments.of("7.4.2", AGPVersion(7, 4, Stable, 2)),
				Arguments.of("7.4.1", AGPVersion(7, 4, Stable, 1)),
				Arguments.of("7.4.0", AGPVersion(7, 4, Stable, 0)),
				Arguments.of("7.4.0-rc03", AGPVersion(7, 4, Candidate, 3)),
				Arguments.of("7.4.0-rc02", AGPVersion(7, 4, Candidate, 2)),
				Arguments.of("7.4.0-rc01", AGPVersion(7, 4, Candidate, 1)),
				Arguments.of("7.4.0-beta05", AGPVersion(7, 4, Beta, 5)),
				Arguments.of("7.4.0-beta04", AGPVersion(7, 4, Beta, 4)),
				Arguments.of("7.4.0-beta03", AGPVersion(7, 4, Beta, 3)),
				Arguments.of("7.4.0-beta02", AGPVersion(7, 4, Beta, 2)),
				Arguments.of("7.4.0-beta01", AGPVersion(7, 4, Beta, 1)),
				Arguments.of("7.4.0-alpha10", AGPVersion(7, 4, Alpha, 10)),
				Arguments.of("7.4.0-alpha09", AGPVersion(7, 4, Alpha, 9)),
				Arguments.of("7.4.0-alpha08", AGPVersion(7, 4, Alpha, 8)),
				Arguments.of("7.4.0-alpha07", AGPVersion(7, 4, Alpha, 7)),
				Arguments.of("7.4.0-alpha06", AGPVersion(7, 4, Alpha, 6)),
				Arguments.of("7.4.0-alpha05", AGPVersion(7, 4, Alpha, 5)),
				Arguments.of("7.4.0-alpha04", AGPVersion(7, 4, Alpha, 4)),
				Arguments.of("7.4.0-alpha03", AGPVersion(7, 4, Alpha, 3)),
				Arguments.of("7.4.0-alpha02", AGPVersion(7, 4, Alpha, 2)),
				Arguments.of("7.4.0-alpha01", AGPVersion(7, 4, Alpha, 1)),
				Arguments.of("7.3.1", AGPVersion(7, 3, Stable, 1)),
				Arguments.of("7.3.0", AGPVersion(7, 3, Stable, 0)),
				Arguments.of("7.3.0-rc01", AGPVersion(7, 3, Candidate, 1)),
				Arguments.of("7.3.0-beta05", AGPVersion(7, 3, Beta, 5)),
				Arguments.of("7.3.0-beta04", AGPVersion(7, 3, Beta, 4)),
				Arguments.of("7.3.0-beta03", AGPVersion(7, 3, Beta, 3)),
				Arguments.of("7.3.0-beta02", AGPVersion(7, 3, Beta, 2)),
				Arguments.of("7.3.0-beta01", AGPVersion(7, 3, Beta, 1)),
				Arguments.of("7.3.0-alpha09", AGPVersion(7, 3, Alpha, 9)),
				Arguments.of("7.3.0-alpha08", AGPVersion(7, 3, Alpha, 8)),
				Arguments.of("7.3.0-alpha07", AGPVersion(7, 3, Alpha, 7)),
				Arguments.of("7.3.0-alpha06", AGPVersion(7, 3, Alpha, 6)),
				Arguments.of("7.3.0-alpha05", AGPVersion(7, 3, Alpha, 5)),
				Arguments.of("7.3.0-alpha04", AGPVersion(7, 3, Alpha, 4)),
				Arguments.of("7.3.0-alpha03", AGPVersion(7, 3, Alpha, 3)),
				Arguments.of("7.3.0-alpha02", AGPVersion(7, 3, Alpha, 2)),
				Arguments.of("7.3.0-alpha01", AGPVersion(7, 3, Alpha, 1)),
				Arguments.of("7.2.2", AGPVersion(7, 2, Stable, 2)),
				Arguments.of("7.2.1", AGPVersion(7, 2, Stable, 1)),
				Arguments.of("7.2.0", AGPVersion(7, 2, Stable, 0)),
				Arguments.of("7.2.0-rc02", AGPVersion(7, 2, Candidate, 2)),
				Arguments.of("7.2.0-rc01", AGPVersion(7, 2, Candidate, 1)),
				Arguments.of("7.2.0-beta04", AGPVersion(7, 2, Beta, 4)),
				Arguments.of("7.2.0-beta03", AGPVersion(7, 2, Beta, 3)),
				Arguments.of("7.2.0-beta02", AGPVersion(7, 2, Beta, 2)),
				Arguments.of("7.2.0-beta01", AGPVersion(7, 2, Beta, 1)),
				Arguments.of("7.2.0-alpha07", AGPVersion(7, 2, Alpha, 7)),
				Arguments.of("7.2.0-alpha06", AGPVersion(7, 2, Alpha, 6)),
				Arguments.of("7.2.0-alpha05", AGPVersion(7, 2, Alpha, 5)),
				Arguments.of("7.2.0-alpha04", AGPVersion(7, 2, Alpha, 4)),
				Arguments.of("7.2.0-alpha03", AGPVersion(7, 2, Alpha, 3)),
				Arguments.of("7.2.0-alpha02", AGPVersion(7, 2, Alpha, 2)),
				Arguments.of("7.2.0-alpha01", AGPVersion(7, 2, Alpha, 1)),
				Arguments.of("7.1.3", AGPVersion(7, 1, Stable, 3)),
				Arguments.of("7.1.2", AGPVersion(7, 1, Stable, 2)),
				Arguments.of("7.1.1", AGPVersion(7, 1, Stable, 1)),
				Arguments.of("7.1.0", AGPVersion(7, 1, Stable, 0)),
				Arguments.of("7.1.0-rc01", AGPVersion(7, 1, Candidate, 1)),
				Arguments.of("7.1.0-beta05", AGPVersion(7, 1, Beta, 5)),
				Arguments.of("7.1.0-beta04", AGPVersion(7, 1, Beta, 4)),
				Arguments.of("7.1.0-beta03", AGPVersion(7, 1, Beta, 3)),
				Arguments.of("7.1.0-beta02", AGPVersion(7, 1, Beta, 2)),
				...
				Arguments.of("7.0.4", AGPVersion(7, 0, Stable, 4)),
