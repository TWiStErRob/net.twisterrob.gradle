 ...
 */
@Suppress("USELESS_IS_CHECK") // LintBaseTask : VariantAwareTask was historically not true.
val LintBaseTask.androidVariantName: String?
	get() = when (this) {
		is VariantAwareTask -> variantName // >=3.3
		is AndroidVariantTask -> variantName // <3.3
